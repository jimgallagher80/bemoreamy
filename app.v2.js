(() => {
  ...
  function lineStyle(state) {
    // "normal" | "dim" | "selected"
    if (state === "selected") {
      return { color: ORANGE, weight: 10, opacity: 0.95, lineCap: "round", lineJoin: "round" };
    }
    if (state === "dim") {
      return { color: GREY, weight: 5, opacity: 0.65, lineCap: "round", lineJoin: "round" };
    }
    return { color: ORANGE, weight: 6, opacity: 0.95, lineCap: "round", lineJoin: "round" };
  }
